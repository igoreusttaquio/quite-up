...
export const transactionsApi = {
  ...
  create: (data: {
    type: string; value: number; date: string; accountId: string;
    categoryId?: string; destinationAccountId?: string; description?: string
  }) => api.post<Transaction>('/transactions', data),
  update: (id: string, data: { value?: number; date?: string; categoryId?: string; description?: string }) =>
