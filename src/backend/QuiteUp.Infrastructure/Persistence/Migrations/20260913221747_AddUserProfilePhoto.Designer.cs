...
namespace QuiteUp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913221747_AddUserProfilePhoto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuiteUp.Domain.Entities.Attachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("QuiteUp.Domain.Entities.DebtPayment", b =>
                {
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("ix_debt_payments_account_id");

                    b.HasIndex("DebtId")
                        .HasDatabaseName("ix_debt_payments_debt_id");

                    b.HasIndex("TransactionId")
                        .HasDatabaseName("ix_debt_payments_transaction_id");
            ...
            modelBuilder.Entity("QuiteUp.Domain.Entities.UserProfilePhoto", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_profile_photos_user_id");
            ...
            modelBuilder.Entity("QuiteUp.Domain.Entities.Attachment", b =>
                {
                    b.HasOne("QuiteUp.Domain.Entities.Transaction", "Transaction")
                        .WithOne("Attachment")
                        .HasForeignKey("QuiteUp.Domain.Entities.Attachment", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuiteUp.Domain.Entities.UserProfilePhoto", b =>
                {
                    b.HasOne("QuiteUp.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("QuiteUp.Domain.Entities.UserProfilePhoto", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
